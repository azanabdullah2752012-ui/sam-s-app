        ...
        <Scroll3DWrapper>
          <div className="glass p-10 rounded-3xl border border-neoBorder flex flex-col justify-between h-full hover-lift relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-full border border-neoBorder flex items-center justify-center bg-white/30 mb-6">
                <span className="text-3xl animate-float">📦</span>
              </div>
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Maker Inventory</h3>
            ...
            <button onClick={() => navigate('/inventory')} className="w-full py-4 bg-black/50 border border-neoBorder btn-spring font-bold rounded-xl text-sm transition mt-auto text-gray-900 relative z-10">
        ...
        <Scroll3DWrapper>
          <div className="glass p-10 rounded-3xl border border-neoBorder flex flex-col justify-between h-full hover-lift relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Impact Calculator</h3>
              <p className="text-sm text-gray-500 leading-relaxed mb-8">
            ...
            <button className="w-full py-4 bg-black/40 border border-white/5 font-bold rounded-xl text-sm mt-auto text-gray-400 cursor-not-allowed relative z-10">
              Offline (Coming Soon)
            </button>
          </div>
        </Scroll3DWrapper>
