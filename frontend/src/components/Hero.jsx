            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input 
                  ...
                  className="bg-[rgba(20,9,30,0.5)] border border-neoBorder rounded-lg p-3 text-sm text-white placeholder-white/30 outline-none w-full input-glow transition" 
                />
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button 
                  ...
                  className="bg-[rgba(20,9,30,0.6)] border border-neoBorder rounded-lg px-6 py-2 text-sm font-medium flex items-center justify-center gap-2 btn-spring"
                >
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-white/60 ${isReviewing ? 'animate-pulse' : ''}`}><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
      ...
      <Scroll3DWrapper className="w-full max-w-4xl mt-16 z-10">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="glass hover-lift rounded-xl p-6 flex flex-col justify-between border border-neoBorder h-40">
            ...
            <button 
              onClick={() => navigate('/planner')}
              className="w-full bg-[rgba(20,9,30,0.6)] border border-neoBorder rounded-lg py-2 text-xs font-medium text-white/70 btn-spring flex justify-between px-4 items-center"
            >
              Open Tool!
