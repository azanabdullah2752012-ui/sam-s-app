...
const Hero = () => {
  ...
  const handleReview = async () => {
    setLoading(true);
    try {
      await fetch('http://localhost:5000/api/review-work', {
        method: 'POST',
      ...
      setLoading(false);
      alert('Review complete! (Mock Mode)');
    }
  };
        ...
        <div className="glass rounded-2xl p-10 relative overflow-hidden">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="bg-[rgba(20,9,30,0.5)] border border-neoBorder rounded-lg p-3 flex items-center justify-between text-sm">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="text" placeholder="Enter a word (like 'mask' or 'planter')" className="bg-[rgba(20,9,30,0.5)] border border-neoBorder rounded-lg p-3 text-sm text-white placeholder-white/30 outline-none w-full" />
              </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <button className="bg-button-gradient border border-neoAccent/40 rounded-lg px-6 py-3 text-sm font-medium flex items-center gap-2 hover:bg-white/5 transition">
              ...
              <div className="flex flex-col gap-2">
                <button className="bg-[rgba(20,9,30,0.6)] border border-neoBorder rounded-lg px-6 py-2 text-sm font-medium flex items-center justify-center gap-2 hover:bg-white/5 transition">
      ...
      <div className="w-full max-w-4xl mt-12 z-10">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="glass rounded-xl p-6 flex flex-col justify-between border border-neoBorder h-40">
            ...
            <button className="w-full bg-[rgba(20,9,30,0.6)] border border-neoBorder rounded-lg py-2 text-xs font-medium text-white/70 hover:text-white transition flex justify-between px-4 items-center">
              Open Tool!
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 18 15 12 9 6"></polyline></svg>
            </button>
          </div>
