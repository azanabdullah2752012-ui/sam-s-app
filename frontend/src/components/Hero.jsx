    ...
    <div className="w-full min-h-screen flex flex-col items-center pt-32 pb-20 px-4">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-16">
        ...
        <div className="flex flex-col w-full z-10 lg:col-span-5">
          ...
          <Scroll3DWrapper className="text-left mb-10 relative z-10">
            <h1 className="text-6xl font-bold mb-6 tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-gray-900 to-gray-600">
              Welcome to the NeoLab! 🤖
            </h1>
            <p className="text-lg text-gray-600 max-w-xl flex items-center justify-start gap-2">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-2 relative dropdown-container">
                <label className="text-xs text-gray-500">What do you have?</label>
                <div 
                  onClick={() => {setIsMaterialOpen(!isMaterialOpen); setIsProjectOpen(false);}}
                  className="bg-white/40 border border-neoBorder rounded-lg p-3 flex items-center justify-between text-sm cursor-pointer hover:bg-[rgba(20,9,30,0.7)] transition"
                >
                  <div className="flex items-center gap-2 text-gray-700">
                    <span>{material.icon}</span> {material.label}
                  </div>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-gray-400"><polyline points="6 9 12 15 18 9"></polyline></svg>
                </div>
                {isMaterialOpen && (
                  <div className="absolute top-[100%] mt-2 left-0 w-full glass border border-neoBorder rounded-lg p-2 z-50 shadow-xl">
                    {MATERIALS.map(m => (
                      <div 
                        ...
                        className="flex items-center gap-2 p-2 rounded-md hover:bg-black/10 cursor-pointer text-sm text-gray-700"
                      >
              ...
              <div className="flex flex-col gap-2 relative dropdown-container">
                <label className="text-xs text-gray-500">What do you want to make?</label>
                <div 
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs text-gray-500">2. Search for something... <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="inline"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></label>
                <input 
                  type="text" 
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Enter a word (like 'mask' or 'planter')" 
                  className="bg-white/40 border border-neoBorder rounded-lg p-3 text-sm text-gray-900 placeholder-white/30 outline-none w-full input-glow transition" 
                />
              </div>
          ...
          <div>
            <h3 className="text-base font-semibold mb-6 flex items-center gap-2">
              ...
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-gray-400"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path></svg>
            </h3>
            ...
            <div className="flex items-center gap-4">
              <button 
                ...
                className="bg-button-gradient border border-neoAccent/40 rounded-lg px-6 py-3 text-sm font-medium flex items-center gap-2 btn-spring disabled:opacity-50"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-neoAccent ${isGenerating ? 'animate-spin' : ''}`}><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
              ...
              <div className="flex flex-col gap-2">
                ...
                <button 
                  ...
                  className="bg-black/50 border border-neoBorder rounded-lg px-6 py-2 text-sm font-medium flex items-center justify-center gap-2 btn-spring"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-gray-500"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg>
                  Snap Photo
                </button>
                <button 
                  onClick={handleReview}
                  disabled={isReviewing}
                  className="bg-review-gradient border border-neoBorder rounded-lg px-6 py-2 text-sm font-medium flex items-center justify-center gap-2 btn-spring disabled:opacity-50"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`text-gray-500 ${isReviewing ? 'animate-pulse' : ''}`}><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                ...
                <div className="flex flex-col gap-2">
                  {generatedIdeas.map((idea, i) => (
                    <div 
                      ...
                      className="bg-white/30 p-3 rounded-lg flex justify-between items-center text-sm cursor-pointer hover:bg-black/50 transition border border-transparent hover:border-neoAccent/50"
                    >
                      <span className="text-gray-800">{idea.title}</span>
            ...
            {selectedIdea && (
              <div className="mt-8 p-6 glass rounded-xl border border-neoAccent animate-fade-in">
                <button 
                  ...
                  className="text-xs text-gray-400 hover:text-gray-900 mb-4 flex items-center gap-1 transition"
                >
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-2">{selectedIdea.title}</h4>
                ...
                <button 
                  ...
                  className="w-full mt-6 py-2 bg-button-gradient border border-neoAccent/40 hover:bg-black/5 font-medium rounded-lg text-sm transition text-gray-900"
                >
                  Save to Planner
                </button>
              </div>
            ...
            {reviewResult && (
              <div className="mt-8 p-4 glass rounded-xl border border-green-500/40 bg-green-900/20 animate-fade-up ai-scanner">
      ...
      <Scroll3DWrapper className="w-full max-w-4xl mt-16 z-10">
        <h2 className="text-lg font-semibold mb-6 flex items-center gap-2">
          ...
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-gray-500"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
        </h2>
        
        <div className="grid grid-cols-2 gap-6">
          {/* Project Planner Card */}
          <div className="glass hover-lift rounded-xl p-6 flex flex-col justify-between border border-neoBorder h-40">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full border border-neoBorder flex items-center justify-center bg-[rgba(20,9,30,0.3)]">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-gray-500"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-gray-800">Project Planner 📝</h4>
                <p className="text-xs text-gray-400 mt-1">Plan</p>
              </div>
            </div>
            <button 
              onClick={() => navigate('/planner')}
              className="w-full bg-black/50 border border-neoBorder rounded-lg py-2 text-xs font-medium text-gray-600 btn-spring flex justify-between px-4 items-center"
            >
              Open Tool!
          ...
          <div className="glass hover-lift rounded-xl p-6 flex flex-col justify-between border border-neoBorder h-40">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-sm font-semibold text-gray-800">Stuff You Need 📦</h4>
                <p className="text-xs text-gray-400 mt-1">Maker Stuff</p>
              </div>
            </div>
            <button 
